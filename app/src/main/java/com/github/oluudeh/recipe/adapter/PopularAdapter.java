...
public class PopularAdapter extends RecyclerView.Adapter<PopularAdapter.FoodHolder>{

    private Context context;
    private ArrayList<Food> foods;

    public PopularAdapter(Context context, ArrayList<Food> foods) {
    ...
    public FoodHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.popular_inflater, parent, false);
